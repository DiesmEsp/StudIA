...
def generar_roadmap():
    ...
    cursos = exportar_cursos_desde_sqlite("app.db")
    ...
    try:
        ...
        with open("logs/raw_response.txt", "w", encoding="utf-8") as f:
            f.write(contenido)
        ...
        # 2. Guardar output
        with open("logs/last_output.json", "w", encoding="utf-8") as f:
        ...
        plt.tight_layout()
        plt.savefig("logs/last_graph.png", dpi=300)
        plt.close()
